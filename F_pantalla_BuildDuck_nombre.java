...
public class F_pantalla_BuildDuck_nombre extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.f_activity_pantalla_build_duck_nombre);
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.buildaduck_musicainicial);
        //La iniciamos
        mediaPlayer.start();
    ...
    public void Jugar(View view) {
        ...
        if (!nombre.equals("")) {//Si ha escrito algo en el nombre
            ...
            Intent intent = new Intent(this, F_pantalla_buildaduck_nivel1.class);
